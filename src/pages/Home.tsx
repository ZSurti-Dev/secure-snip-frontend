                  ...
                  <div className="flex flex-col sm:flex-row justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <button
                        ...
                        className={`bg-red-500 hover:bg-red-600 text-white px-5 py-3 rounded-lg font-medium shadow-sm transition-all duration-300 w-full sm:w-auto flex items-center justify-center min-w-[90px] ${
